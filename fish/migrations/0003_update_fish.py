# Generated by Django 5.0.6 on 2026-03-23 11:53

from django.db import migrations


def update_fish(apps, schema_editor):
    ...
    fishes = [
        ...
        },
        {
            "fish_id": 10,
            "name": "Zander",
            "description": "A predatory freshwater fish known for its sharp vision.",
            "habitat": "LAKE",
            "rarity": "LEGENDARY",
            "base_weight": 8.0,
            "base_price": 95,
        ...
        },
        {
            "fish_id": 13,
            "name": "Tuna",
            "description": "A fast-swimming ocean predator valued commercially.",
            "habitat": "OCEAN",
            "rarity": "COMMON",
            "base_weight": 150.0,
            "base_price": 80,
        },
        {
            "fish_id": 14,
            "name": "Swordfish",
            "description": "A large predator with a long, flat bill.",
            "habitat": "OCEAN",
            "rarity": "RARE",
            "base_weight": 200.0,
            "base_price": 150,
        ...
        },
        {
            "fish_id": 17,
            "name": "Octopus",
            "description": "An intelligent cephalopod known for its camouflage.",
            "habitat": "OCEAN",
            "rarity": "COMMON",
            "base_weight": 15.0,
            "base_price": 60,
        },
        {
            "fish_id": 18,
            "name": "Lionfish",
            "description": "A venomous fish with striking spines.",
            "habitat": "OCEAN",
            "rarity": "RARE",
            "base_weight": 1.2,
            "base_price": 70,
        },
        {
            "fish_id": 19,
            "name": "Moray Eel",
            "description": "A long, snake-like fish hiding in coral reefs.",
            "habitat": "OCEAN",
            "rarity": "RARE",
            "base_weight": 12.0,
            "base_price": 85,
    ...
    for data in fishes:
        Fish.objects.update_or_create(fish_id=data["fish_id"], defaults=data)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_fish),
    ]
